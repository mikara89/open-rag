...
- JWT Authority or Audience is missing, the Authority URI is invalid or violates the HTTPS-metadata policy, claim names are blank, or clock skew is outside 0–300 seconds.
